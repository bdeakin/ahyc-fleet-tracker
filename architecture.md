...
7. Kiosk colors traffic markers by AIS ship type (club vessels keep registry colors); live view draws a 10-minute trail per vessel; click or search a vessel to zoom, open a detail pane, and draw a 24h track.
