...
- Live AIS is viewport-scoped and refreshes every 5 seconds; map sets maxZoom for marker clustering; traffic clusters when zoomed out; filter markers by source (Radio / AISHub / AISStream)
